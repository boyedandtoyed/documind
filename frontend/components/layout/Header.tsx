...
export function Header() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-[#1E1E2E] bg-[#0A0A0F]/80 px-6 backdrop-blur-sm">
      <div>
      ...
      <div className="flex items-center gap-3">
        {ollamaStatus === 'checking' ? (
          <span className="flex items-center gap-1.5 rounded-full border border-[#1E1E2E] bg-[#13131F] px-3 py-1 text-xs text-[#64748B]">
